...
class Bridge(object):
    ...
    :param AWSIoTMQTTClient.Client _mqtt_client: MQTT client
...
class MqttToRosBridge(Bridge):
    ...
    def _callback_mqtt(self, client, userdata, mqtt_msg):
        ...
        :param AWSIoTMQTTClient.Client client: MQTT client used in connection
        :param userdata: user defined data
        :param AWSIoTMQTTClient.MQTTMessage mqtt_msg: MQTT message
        """
    ...
    def _create_ros_message(self, mqtt_msg):
        ...
        :param AWSIoTMQTTClient.Message mqtt_msg: MQTT Message
